...
class ProgressEthiopianWidgetDarkProvider : AppWidgetProvider() {

    companion object {
        private const val PREFS_NAME = "FlutterSharedPreferences"
        private const val KEY_PREFIX = "flutter_android_widgets_"
        const val ACTION_REFRESH = "com.anexon.ethio_cal.ProgressEthiopianWidgetDarkProvider.ACTION_REFRESH"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == ACTION_REFRESH) {
            ...
            val ids = mgr.getAppWidgetIds(ComponentName(context, ProgressEthiopianWidgetDarkProvider::class.java))
    ...
    private fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
        ...
        val views = RemoteViews(context.packageName, R.layout.widget_progress_ethiopian_dark)
