...
class ProgressGregorianWidgetDarkProvider : AppWidgetProvider() {

    companion object {
        private const val PREFS_NAME = "FlutterSharedPreferences"
        private const val KEY_PREFIX = "flutter_android_widgets_"
        const val ACTION_REFRESH = "com.anexon.ethio_cal.ProgressGregorianWidgetDarkProvider.ACTION_REFRESH"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == ACTION_REFRESH) {
            ...
            val ids = mgr.getAppWidgetIds(ComponentName(context, ProgressGregorianWidgetDarkProvider::class.java))
    ...
    private fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
        ...
        val views = RemoteViews(context.packageName, R.layout.widget_progress_gregorian_dark)
