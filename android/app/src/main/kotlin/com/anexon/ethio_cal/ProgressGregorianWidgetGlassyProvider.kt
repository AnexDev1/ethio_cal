...
class ProgressGregorianWidgetGlassyProvider : AppWidgetProvider() {

    companion object {
        private const val PREFS_NAME = "FlutterSharedPreferences"
        private const val KEY_PREFIX = "flutter_android_widgets_"
        const val ACTION_REFRESH = "com.anexon.ethio_cal.ProgressGregorianWidgetGlassyProvider.ACTION_REFRESH"
        ...
        private const val UNFILLED_COLOR = "#AAAAAA"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == ACTION_REFRESH) {
            ...
            val ids = mgr.getAppWidgetIds(ComponentName(context, ProgressGregorianWidgetGlassyProvider::class.java))
    ...
    private fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
        ...
        val views = RemoteViews(context.packageName, R.layout.widget_progress_gregorian_glassy)
        ...
        val dayPercentText = getString("greg_day_percent", "0%")
        val weekPercentText = getString("greg_week_percent", "0%")
        val monthPercentText = getString("greg_month_percent", "0%")
        val yearPercentText = getString("greg_year_percent", "0%")
